...
export const ChatControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateChat: async (chatId: string, chatUpdateRequest: ChatUpdateRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'chatId' is not null or undefined
            assertParamExists('updateChat', 'chatId', chatId)
            // verify required parameter 'chatUpdateRequest' is not null or undefined
            assertParamExists('updateChat', 'chatUpdateRequest', chatUpdateRequest)
            const localVarPath = `/api/chats/{chatId}`
                .replace(`{${"chatId"}}`, encodeURIComponent(String(chatId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const ChatControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async updateChat(chatId: string, chatUpdateRequest: ChatUpdateRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponseChatDetailResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateChat(chatId, chatUpdateRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ChatControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateChat(chatId: string, chatUpdateRequest: ChatUpdateRequest, options?: RawAxiosRequestConfig): AxiosPromise<ApiResponseChatDetailResponse> {
            return localVarFp.updateChat(chatId, chatUpdateRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ChatControllerApi extends BaseAPI {
     ...
     * @memberof ChatControllerApi
     */
    public updateChat(chatId: string, chatUpdateRequest: ChatUpdateRequest, options?: RawAxiosRequestConfig) {
        return ChatControllerApiFp(this.configuration).updateChat(chatId, chatUpdateRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
