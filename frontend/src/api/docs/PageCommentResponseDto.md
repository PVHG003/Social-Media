...
**content** | [**Array&lt;CommentResponseDto&gt;**](CommentResponseDto.md) |  | [optional] [default to undefined]
...
```typescript
import { PageCommentResponseDto } from './api';

const instance: PageCommentResponseDto = {
    totalElements,
    totalPages,
    pageable,
    first,
